...
import chefLeft from "../icons/look_right.svg";
import chefRight from "../icons/look_left.svg";
...
const STEPS = [
  ...
  {
    target: ".youcart-nav-link",
    title: "youCart 🛒",
    content: "Save your favourite ingredients and create shopping lists for your weekly meals!",
    place: "bottom",
    char: "right",
  },
  {
...
function OnboardingTour() {
  ...
  const handleVideoEnd = () => transitionToTour();
    ...
    return (
      <div style={{
        ...
        <button onClick={skipVideo} style={{
          ...
          color: "white", borderRadius: 50, padding: "8px 20px",
          fontSize: 14, cursor: "pointer",
          fontFamily: "Teachers, sans-serif", backdropFilter: "blur(8px)",
        }}>Skip intro →</button>
      </div>
    );
  }
  ...
  const isLeft = current.char === "left";
  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: "rgba(0,0,0,0.6)", zIndex: 9990,
